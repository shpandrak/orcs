...
public class HubWebAppMicroService extends MicroService {
    ...
    protected void initializeService(Context context) {
        ...
        createUser(context, "charles", "1234", "Charlotte", "Lieberman", "charlotte.lieberman@gmail.com", "ac.png", is);
        ...
        createUser(context, "vijay", "1234", "Vijay", "Dell", "michael@dell.com", "michael-dell.jpg", is);
