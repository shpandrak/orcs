 ...
 * Drink responsibly
 */
public class ApplicationCopyAppServiceQueuedEvent extends ApplicationCopyEvent {
    private final String appServiceName;

    private ApplicationCopyAppServiceQueuedEvent() {
        this(null, null, 0, null, null, null);
    }

    public ApplicationCopyAppServiceQueuedEvent(UUID id, UUID appInstanceId, long version, Date timeStamp,
