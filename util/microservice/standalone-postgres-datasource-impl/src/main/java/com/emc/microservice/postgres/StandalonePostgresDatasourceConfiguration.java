 ...
 */
public class StandalonePostgresDatasourceConfiguration extends DatasourceConfiguration {

    private static final String CONFIGURATION_NAME = "Postgres Standalone";
    ...
    public StandalonePostgresDatasourceConfiguration(
            String server,
            int port,
            String dbName,
            String dbSchemaName,
    ...
    protected StandalonePostgresDatasourceConfiguration(
