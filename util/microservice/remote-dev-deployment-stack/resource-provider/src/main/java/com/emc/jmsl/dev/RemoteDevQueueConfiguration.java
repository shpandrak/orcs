 ...
 * Drink responsibly
 */
public class RemoteDevQueueConfiguration extends QueueConfiguration {
    ...
    public RemoteDevQueueConfiguration() {
        super("Dev Destination Messaging", PROPERTIES);
    }

    public RemoteDevQueueConfiguration(MessageDestinationType messageDestinationType) {
        this();
