                    ...
                    try (Connection c = dataSource.getConnection()) {
                        ...
                        if (myRunnable.finishedWithError != null) {
                            throw new IllegalStateException(
                                    "Failed finishing copy stream for service " + serviceType + "/" + serviceName,
                                    myRunnable.finishedWithError);
                        }

                    } catch (SQLException | InterruptedException e) {
                        throw new IllegalStateException(
                                "Failed importing copy stream for service " + serviceType + "/" + serviceName,
                                e);
                    }
                    break;
                default:
